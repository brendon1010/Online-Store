...
export default function NavBar(){
    ...
    return(
        <Nav fill variant="tabs" style={{padding: '15px', backgroundColor: 'grey', color: 'white', cursor: 'pointer'}}>
            ...
            <Nav.Item className="linkItem"><NavLink to='/user'><img className="pPic" src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" alt="userImg"/></NavLink></Nav.Item>
        </Nav>
    )
}